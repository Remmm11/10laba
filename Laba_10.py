...
class game:
    ...
    def games(self):
        ...
        Label(self.main, text='Крестики & Нолики:', font='Arial 30 bold').place(x=205, y=100)
        button_first = ttk.Button(self.main, text='Играть', style='my.TButton', command=lambda: field())
        button_first.place(x=320, y=220)
